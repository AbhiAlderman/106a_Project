...
class LinearTrajectory(Trajectory):
    ...
    def target_pose(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            newpos = self.start_position + 0 + 0.5 * self.acceleration * (self.total_time * 0.5) ** 2
            newtime = time - (self.total_time * 0.5)
            pos = newpos + self.v_max * newtime - 0.5 * self.acceleration * newtime**2
    ...
    def target_velocity(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            newtime = time - (self.total_time * 0.5)
            linear_vel = self.v_max - self.acceleration * newtime
...
class CircularTrajectory(Trajectory):
    ...
    def target_pose(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            newtime = time - (self.total_time * 0.5)
            theta = np.pi + self.angular_v_max * newtime - 0.5 * self.angular_acceleration * newtime**2
    ...
    def target_velocity(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            newtime = time - (self.total_time * 0.5)
            theta = np.pi + self.angular_v_max * newtime - 0.5 * self.angular_acceleration * newtime**2
            theta_dot = self.angular_v_max - self.angular_acceleration * newtime
